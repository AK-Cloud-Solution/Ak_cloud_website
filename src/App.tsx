...
import { AgentsSection, CTASection, Footer, HumanAISection, KnowledgeDiagram, ProjectPortfolio, ProductShowcase, SecuritySection } from "./components/LandingSections";
...
function PublicExperience() {
  ...
  return <div className="ak-site-new"><AKNavigation onRequestDemo={() => scroll("#contact")} /><main><AKHero content={content.hero} onPrimaryClick={() => scroll("#contact")} onSecondaryClick={() => scroll("#platform")} /><ProjectPortfolio /><ProductShowcase /><HumanAISection /><AgentsSection /><KnowledgeDiagram /><SecuritySection /><CTASection /></main><Footer /><Toaster /></div>;
}
